...
public interface ICourseQueries
{
    ...
    Task<IReadOnlyList<Course>> GetPopularCourses(uint limit, CancellationToken cancellationToken);
    ...
    Task<IReadOnlyList<Course>> Filter(string? search, IEnumerable<CategoryId> categories, CancellationToken cancellationToken);
}